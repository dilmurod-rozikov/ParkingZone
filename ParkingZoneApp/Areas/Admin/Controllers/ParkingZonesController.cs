...
namespace ParkingZoneApp.Areas.Admin.Controllers
{
    ...
    public class ParkingZonesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Address,CreatedDate")] ParkingZone parkingZone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,FirstName,LastName,Address,CreatedDate")] ParkingZone parkingZone)
        {
